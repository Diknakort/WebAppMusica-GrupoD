...
namespace WebApplication_MUSICA_grupoD.Controllers
{
    public class GirasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha_Inicio,Nombre,Fecha_Final")] Giras giras)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha_Inicio,Nombre,Fecha_Final")] Giras giras)
        {
            if (id != giras.Id)
            {
                return NotFound();
